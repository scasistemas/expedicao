 ...
 */
public class ListCargasBaixadas extends Activity implements AdapterView.OnItemClickListener, AsyncResponse {
    ...
    public void listar() {
        ...
        sdc = new SincDadosLocal(config,1);
        ...
        dialog = ProgressDialog.show(ListCargasBaixadas.this, "Verificando", "Atualizando lista ...", false, true);
        t.start();
    ...
    private void populateListView() {
        ...
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                BaseAdapterC baf = new BaseAdapterC(ListCargasBaixadas.this, fillMaps, cargaList, "");
        ...
        new AlertDialog.Builder(this)
                .setItems(R.array.op_cargas_ab, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialoginterface, int i) {
                        new AlertDialog.Builder(ListCargasBaixadas.this)
                                ...
                                .setItems(R.array.op_alerta_sim_nao, new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialoginterface, int i) {
                                        if (i == 0) {
                                            Config config = new DaoConfig(ListCargasBaixadas.this).consultar();
                                            SincDadosLocal sdc = new SincDadosLocal(config, 1);
                                            sdc.deleteFile(carga);
                                            sdc.deleteFile("env_"+carga);
                                            ListCargasBaixadas.this.deleteDatabase(carga);
                                            ListCargasBaixadas.this.deleteDatabase("env_" + carga);
    ...
    public void voltar(View v){
        ListCargasBaixadas.this.finish();
    }
